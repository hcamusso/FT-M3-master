...
function problemA () {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-01.txt').then((successMessage) =>
  {
...
function problemB () {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-02.txt').then((successMessage) =>
  {
    console.log('-- B. promise version (stanza two) --');
    blue(successMessage);
  });
  promisifiedReadFile('poem-one/stanza-03.txt').then((successMessage) =>
  {
...
function problemD () {
  ...
  promisifiedReadFile('poem-one/stanza-04.txt').then((successMessage) => {
    console.log('-- D. promise version (stanza four) --');
    blue(successMessage);
  }, (reason) => {
    console.log('-- D. promise version (stanza four) ERROR --');
    magenta(new Error(reason));
  });
...
function problemE () {
  ...
  promisifiedReadFile('poem-one/stanza-03.txt').then((successMessage) =>
  {
    console.log('-- E. promise version (stanza 3) --');
    blue(successMessage);
    return promisifiedReadFile('poem-one/s.txt');
  })
  .then((successMessage) =>
  {
    console.log('-- E. callback version (stanza four) --');
...
function problemF () {
  ...
  promisifiedReadFile('poem-one/stanza-03.txt')
    .then((successMessage) =>{
        ...
        console.log('-- F. callback version done --')});
    // Alternativa poner los console.log 'done'
    //.finally( () => console.log(done'))
}
// Resolucion compacta:
// promisifiedReadFile( filename: 'poem-one/stanza-03.txt')
//   .then(stanza3 => {blue(stanza3); return promisifiedReadFile( filename: 'poem-one/s.txt')})
